        ...
        LocationListener
{
    ...
    public void LoadRest(){
        ...
        if (res.getCount() == 0){
            ...
            Toast.makeText(MapActivity.this, "No hay restaurantes en la base de datos", Toast.LENGTH_LONG).show();
            return;
        }

        while (res.moveToNext()){
            String dbNombre = res.getString(1);
            String dbLatitud = res.getString(2);
            String dbLongitud = res.getString(3);
